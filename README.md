...
- `google/gemma-3-12b-it` — крепкая классификация и связные ответы в среднем размере.
- `llama-3.1-8b-instant` — быстрый дешёвый фолбэк (Groq).
- `mistralai/mistral-7b-instruct`, `qwen/qwen3-4b` — диверсификация вендоров через OpenRouter.
- `google/gemma-3-4b-it`, `meta-llama/llama-3.2-3b-instruct` — лёгкие запасные варианты.
